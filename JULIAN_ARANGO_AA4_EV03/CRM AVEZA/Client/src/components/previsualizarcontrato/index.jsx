...
const PrevisualizarContrato = ({ cliente}) => {
  if (cliente.length > 0) {
    return (
      <div>
          ...
          <div className="contenedorcontrato">
            <h1 className="tituloo">
              ...
              <input
                ...
                name="cliente"
                id="nombrecliente"
                className="cajacliente"
                value={`${cliente[0].nombres} ${cliente[0].apellidos}`}
              />
            ...
            <p>
              ...
              <input
                ...
                className="cajacliente"
              />
              y portador de la Tarjeta Profesional de Abogado No.
              <input
                type="text"
                name="Notarjetaprofesional"
                id="name"
                className="cajacliente"
              />
              ...
              <input
                type="number"
                name="nocuentaahorros"
                id="nocuentaahorros"
                className="cajacliente"
              />
              del banco de Colombia a nombre de
              <input
                type="text"
                name="abogado"
                id="nombreabogado"
              ...
              <input
                type="text"
                name="Correoelectrónicocliente"
                id="Correoelectrónicocliente"
                className="cajacliente"
              ...
              />
              y por parte del APODERADO, Dirección física:
              <input
                type="text"
                name="dirección física"
                id="direccioncliente"
